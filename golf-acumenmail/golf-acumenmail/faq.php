...
$faq = [
    ...
    ['Aufwand', 'Wie viel Zeit kostet das unser Sekretariat?',
     'Nach der Einrichtung liegt eine Ausgabe erfahrungsgemäß bei 20 bis 40 Minuten: Bausteine anordnen, Text schreiben, Vorschau prüfen, senden. Die Automationen laufen danach ohne weiteres Zutun. Wer auch das nicht leisten kann oder will, gibt die Ausgaben in der Clubbetreuung ganz ab.'],
    ...
    ['Umstieg', 'Müssen wir unser bisheriges Tool kündigen?',
     'Nicht zwingend. Zuerst prüfen wir, ob Ihr aktuelles Werkzeug die Segmente und Automationen abbilden kann, die Sie brauchen. Wenn ja, arbeiten wir damit weiter – die Strategie ist wichtiger als das Werkzeug. Ein Wechsel lohnt meist dann, wenn die Kosten mit der Mitgliederzahl steigen, Automationen fehlen oder Mitgliederdaten den EU-Raum verlassen.'],
    ...
    ['Zustellbarkeit', 'Landen die Mails nicht im Spam?',

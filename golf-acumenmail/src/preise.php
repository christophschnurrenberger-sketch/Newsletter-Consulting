...
<section class="section section-alt">
    <div class="container">
        ...
        <div class="callout" style="margin-top:2rem;">
            ...
            <p>
                <strong>Ab wann sich der eigene Weg rechnet</strong>
                Der Aufwand je Ausgabe bleibt gleich, ob 300 oder 3.000 Menschen sie bekommen –
                deshalb trägt sich ein eigenes System umso deutlicher, je größer der Verteiler ist
                und je mehr Anlässe im Jahr zusammenkommen. Wo Ihr Club steht, sehen wir im
                Clubcheck.
            </p>
        </div>
    </div>

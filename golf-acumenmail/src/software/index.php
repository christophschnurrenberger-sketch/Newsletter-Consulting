...
<section class="section section-dark">
    <div class="container">
        ...
        <figure class="shot">
                    <img src="<?= e(url('assets/bilder/tool-angaben.png')) ?>" width="1500" height="755"
                         alt="Schritt zwei im Editor: Betreff, Absender, Empfängerliste, Marke und Messung."
                         loading="lazy" decoding="async">
                    <figcaption>
                        <b>Schritt 2 von 3.</b>
                        <span>Betreff, Absender, Empfängerliste. Der dritte Schritt trägt die Ampel: Solange etwas fehlt, bleibt „Senden“ gesperrt.</span>
                    </figcaption>
                </figure>
    </div>
</section>

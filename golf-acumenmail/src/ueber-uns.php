...
<section class="section section-alt">
    <div class="container">
        <div class="section-head">
            ...
            <h2 class="section-title">Ein System aus der Praxis, nicht aus dem Katalog</h2>
            <p class="section-lead">
                Das Newsletter-System ist über Jahre im täglichen Einsatz gewachsen und wird
                laufend weiterentwickelt. Es steht heute in Clubs und Projekten im Betrieb – und
                jede Funktion darin ist entstanden, weil sie in einem echten Versand gebraucht
                wurde.
            </p>
        </div>

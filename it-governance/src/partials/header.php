 ...
 * sofern die Seite einen Seitenkopf setzt – Brotkrumen und Seitenkopf.
 *
 ...
 *   crumbs      [[Beschriftung, Pfad|null], …] – ohne „Start“
 *   hero        ['kicker' =>, 'h1' =>, 'lead' =>, 'actions' => [[Text, Pfad, 'primary'|'ghost'], …],
 *                'facts' => [[Zahl, Beschriftung], …]]
 *               false unterdrückt den Seitenkopf (für die Startseite)
 *   body_class  zusätzliche Klasse am <body>
 */
...
<head>
    ...
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='6' fill='%230E2A47'/><path d='M8 21V11l8-4 8 4v10' stroke='%23C98A4B' stroke-width='2' fill='none' stroke-linejoin='round'/><path d='M8 21h16' stroke='white' stroke-width='2' stroke-linecap='round'/></svg>">
...
<?php endforeach; ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Beratung für IT-Governance, IT-Prozesse, Auditfähigkeit und regulatorische Anforderungen im Mittelstand.",
      "url": <?= json_encode(rtrim($SITE['domain'], '/') . url('')) ?>,
      "telephone": <?= json_encode($SITE['phone']) ?>,
      "email": <?= json_encode($SITE['email']) ?>,
      "founder": { "@type": "Person", "name": <?= json_encode($SITE['owner']) ?> },
      "address": {
        "@type": "PostalAddress",
        "streetAddress": <?= json_encode($SITE['street']) ?>,
        "addressLocality": <?= json_encode($SITE['city']) ?>,
        "addressCountry": "DE"
      },
      "areaServed": [
      ...
      "serviceType": "IT-Governance-Beratung"
    }
    </script>
</head>
...
<div class="utility-bar">
    <div class="container utility-inner">
        <p class="utility-claim">IT-Governance, IT-Prozesse und Auditfähigkeit für mittelständische Unternehmen</p>
        <div class="utility-links">
            <a href="tel:<?= e($SITE['phone_link']) ?>">
                <i data-icon="phone" class="lucide"></i><?= e($SITE['phone']) ?>
            </a>
            <a href="<?= e(url('faq.php')) ?>">Häufige Fragen</a>
            <a href="<?= e(url('wissen/')) ?>" class="utility-highlight">
                <i data-icon="book-open" class="lucide"></i>Wissensbereich
            </a>
        </div>
    </div>
</div>
    ...
    <div class="container header-inner">
        ...
        <a href="<?= e(url('')) ?>" class="site-brand" aria-label="<?= e($SITE['name']) ?> – Startseite">
            ...
            <span class="site-brand-text">
                <span class="site-brand-name">Schnurrenberger <span class="brand-accent">IT-Governance</span></span>
...
<?php endforeach; ?>
                ...
                <li class="nav-item nav-item-cta">
                    <a href="<?= e(url('kontakt.php')) ?>" class="btn-primary-custom">Erstgespräch vereinbaren</a>
                </li>
            </ul>
        </nav>

        <div class="header-actions">
            <a href="<?= e(url('kontakt.php')) ?>" class="btn-primary-custom header-cta">Erstgespräch vereinbaren</a>
        </div>
